# FOSSHack Jabalpur 2026

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSES/MIT.txt)
[![Event: FOSSHack 2026](https://img.shields.io/badge/Event-FOSSHack%202026-blue)](https://fossunited.org/fosshack/2026)
[![Supported by: FOSS United](https://img.shields.io/badge/Supported%20by-FOSS%20United-green)](https://fossunited.org)

---

## About the Event

**FOSSHack Jabalpur 2026** is the Jabalpur localhost of [FOSSHack 2026](https://fossunited.org/fosshack/2026), India's largest Free and Open Source Software hackathon, now in its **sixth edition**. FOSS Hack is organized by the FOSSHack Community and supported by [FOSS United](https://fossunited.org).
...
| **Registration** | [Register on FOSS United](https://fossunited.org/dashboard/register-for-hackathon?id=1hdcnkbtmk) |
...
For a detailed timeline, refer to [EVENT_TIMELINE.md](EVENT_TIMELINE.md).
...
- [HOTOSM](https://github.com/hotosm/tasking-manager/issues)
- [MapLibre](https://github.com/maplibre/maplibre-native)
- [CircuitVerse](https://github.com/CircuitVerse/CircuitVerse)
- [OpenStreetMap](https://forum.fossunited.org/t/problem-statements-and-ideas-fosshack-2026/7186/2?u=ansh)
- [XenevaOS](https://github.com/manaskamal/XenevaOS)
- [Maxun](https://github.com/getmaxun/maxun)
- [View All Partner Projects](https://fossunited.org/fosshack/2026/partner-projects)

> **Note:** Projects based on Crypto, Web3, or Blockchain technologies are **not allowed**. [Why?](https://forum.fossunited.org/t/a-note-on-blockchain/723)
...
2. Projects must be released under a valid FOSS / Open Source license from the approved list in [LICENSES/](LICENSES/) or another OSI-approved license.
...
5. Be respectful and follow the [FOSS United Code of Conduct](https://fossunited.org/code-of-conduct) at all times.
...
> See the full [Rules & FAQ](https://fossunited.org/fosshack/rules) on the FOSS United website.
...
For full scoring details, refer to [JUDGING_CRITERIA.md](JUDGING_CRITERIA.md).
...
All participants, contributors, and attendees are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md). Respectful, inclusive, and professional behavior is required at all times.

---

## Useful Links

- **Register:** [https://fossunited.org/dashboard/register-for-hackathon?id=1hdcnkbtmk](https://fossunited.org/dashboard/register-for-hackathon?id=1hdcnkbtmk)
- **FOSS Hack 2026:** [https://fossunited.org/fosshack/2026](https://fossunited.org/fosshack/2026)
- **Event Page (FOSS United):** [https://fossunited.org/hack/fosshack26](https://fossunited.org/hack/fosshack26)
- **All Projects:** [https://fossunited.org/hack/fosshack26/projects/all](https://fossunited.org/hack/fosshack26/projects/all)
- **Project Ideas:** [https://forum.fossunited.org/t/problem-statements-and-ideas-fosshack-2026/7186](https://forum.fossunited.org/t/problem-statements-and-ideas-fosshack-2026/7186)
- **Rules & FAQ:** [https://fossunited.org/fosshack/rules](https://fossunited.org/fosshack/rules)
- **Guidelines & FAQ:** [https://forum.fossunited.org/t/foss-hack-rules-guidelines-faq/3334](https://forum.fossunited.org/t/foss-hack-rules-guidelines-faq/3334)
- **GGITS Localhost:** [https://ggits.org/fosshack](https://ggits.org/fosshack)
...
- **FOSS United:** [https://fossunited.org](https://fossunited.org)
